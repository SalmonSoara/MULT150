/* 
 * -Doodled an illustration for the background of the menus
 * -Imported a free font, changed the colors/styles to aim for a silly but intense look
 * -Changed the Start button to change it's text to "Placeholder" when pressed
